...
(function() {
  ...
  document.querySelectorAll('[data-animate], .about-block, .credential-card, .timeline-item, .project-showcase, .skills-intro, .skills-practice, .social-section, .contact-terminal, .contact-form-wrapper').forEach(el => {
    observer.observe(el);
  });
